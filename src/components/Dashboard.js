        ...
        <div className="container py-5">
            <div className="row justify-content-center">
                <div className="col-md-10 col-lg-8">
                    <h1 className="display-4 text-center mb-3">Welcome to iNotebook</h1>
                    ...
                    <div className="card mb-4">
                        <div className="card-body">
                            <h2 className="h4 card-title">Why Choose iNotebook?</h2>
                            <p>Discover why iNotebook is the perfect place to capture and organize your thoughts, ideas, and reminders:</p>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="list-group">
                            <Link to="../signup" className="list-group-item list-group-item-action"><strong>Create an Account:</strong> Sign up for iNotebook to secure and personalize your experience.</Link>
                    ...
                    <footer className="text-center mt-5">
                        <p>Join the iNotebook Community</p>
                        <p>Sign Up and become a part of the iNotebook family.</p>
                    </footer>
                </div>
            </div>
        </div>
